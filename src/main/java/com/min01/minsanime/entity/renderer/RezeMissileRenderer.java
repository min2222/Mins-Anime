...
public class RezeMissileRenderer extends EntityRenderer<EntityRezeMissile>
{
	private final ModelRezeMissile model;
	
	public RezeMissileRenderer(Context p_174008_)
	{
		super(p_174008_);
		this.model = new ModelRezeMissile(p_174008_.bakeLayer(ModelRezeMissile.LAYER_LOCATION));
	}
	
	@Override
	public void render(EntityRezeMissile p_114485_, float p_114486_, float p_114487_, PoseStack p_114488_, MultiBufferSource p_114489_, int p_114490_) 
	{
		p_114488_.pushPose();
	...
	@Override
	public ResourceLocation getTextureLocation(EntityRezeMissile p_114482_)
	{
