...
public class FrierenRenderer extends MobRenderer<EntityFrieren, ModelFrieren>
{
	...
	public void render(EntityFrieren p_115455_, float p_115456_, float p_115457_, PoseStack p_115458_, MultiBufferSource p_115459_, int p_115460_)
	{
		...
		if(p_115455_.isUsingSkill(1))
		{
			p_115458_.pushPose();
			Vec2 rot = p_115455_.getRotation();
			...
			AnimeClientUtil.drawQuad(p_115458_, p_115459_.getBuffer(AnimeRenderType.eyesNoAlpha(new ResourceLocation(MinsAnime.MODID, "textures/effect/zoltraak.png"))), p_115455_.getCircleSize(), LightTexture.FULL_BRIGHT, 1.0F);
			p_115458_.popPose();
